...
4) View the contents of sources.list file
					...
					if repo == "1":
						...
						cmd2 = os.system("echo '# Kali linux repositories | Added by Katoolin\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> $PREFIX/etc/apt/sources.list")
					elif repo == "2":
						cmd3 = os.system("apt-get update -m")
					elif repo == "3":
						infile = "$PREFIX/etc/apt/sources.list"
						outfile = "$PREFIX/etc/apt/sources.list"

						delete_list = ["# Kali linux repositories | Added by Katoolin\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
						os.remove("$PREFIX/etc/apt/sources.list")
						fout = open(outfile, "w+")
						for line in fin:
						...
						file = open('$PREFIX/etc/apt/sources.list', 'r')
